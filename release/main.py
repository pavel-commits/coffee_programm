...
from UI.main_ui import Main_Ui_MainWindow
from UI.sort_ui import Sort_Ui_MainWindow
from UI.addEditCoffeeForm_ui import Add_Ui_MainWindow


class CoffeeWidget(QMainWindow, Main_Ui_MainWindow):
    def __init__(self):
...
class AddClass(QMainWindow, Sort_Ui_MainWindow):
...
class Redactor(QMainWindow, Add_Ui_MainWindow):
